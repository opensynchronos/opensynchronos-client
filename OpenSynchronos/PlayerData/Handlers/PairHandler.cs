...
using Enum_ObjectKind = OpenSynchronos.API.Data.Enum.ObjectKind;
using ObjectKind = OpenSynchronos.API.Data.Enum.ObjectKind;

namespace OpenSynchronos.PlayerData.Handlers;
