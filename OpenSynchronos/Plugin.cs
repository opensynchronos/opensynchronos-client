...
using OpenSynchronos.PlayerData.Factories;
using OpenSynchronos.PlayerData.Pairs;
using OpenSynchronos.PlayerData.Services;
using OpenSynchronos.Services;
using OpenSynchronos.Services.CharaData;
using OpenSynchronos.Services.Events;
using OpenSynchronos.Services.Mediator;
using OpenSynchronos.Services.ServerConfiguration;
using OpenSynchronos.UI;
using OpenSynchronos.UI.Components;
using OpenSynchronos.UI.Components.Popup;
using OpenSynchronos.UI.Handlers;
using OpenSynchronos.WebAPI;
using OpenSynchronos.WebAPI.Files;
using OpenSynchronos.WebAPI.SignalR;

namespace OpenSynchronos;
...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ISigScanner sigScanner)
    {
        ...
        .ConfigureLogging(lb =>
        {
            ...
            lb.AddFile(Path.Combine(traceDir, $"opensynchronos-trace-{DateTime.Now:yyyy-MM-dd-HH-mm-ss}.log"), (opt) =>
                {
                opt.Append = true;
        ...
        {
            collection.AddSingleton(new WindowSystem("OpenSynchronos"));
            collection.AddSingleton<FileDialogManager>();
            collection.AddSingleton(new Dalamud.Localization("OpenSynchronos.Localization.", "", useEmbedded: true));
            ...
            collection.AddSingleton((s) =>
            {
                ...
                httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("OpenSynchronos", ver!.Major + "." + ver!.Minor + "." + ver!.Build));
                return httpClient;
            });
